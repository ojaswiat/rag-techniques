...
- **The filing corpus has since expanded to 13 filings and is fully ingested.** Original corpus was AAPL/MSFT/TSLA × FY2023–2025 (9 filings); expanded to 5 companies by adding JPM and JNJ at FY2023–2024 = 13 filings, all fetched/parsed (18,297 nodes in `benchmark.db`). See `resources/research/deviations.md` entry 20 and `project/data/filings_manifest.json` for the authoritative current list.
