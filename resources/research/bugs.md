...
### 1. LLMFactory's retry/backoff wrapper was silently never applied (2026-08-11)
...
### 2. Chroma silently dropped real filing data on duplicate node IDs (2026-08-10)
...
### 3. ChromaVectorStore's reserved metadata key silently overwrote our own `document_id` (2026-08-10)
...
### 4. Structural metadata leaked into P1's embedded/reranked text (2026-08-10)
...
### 5. `storage_root` late-binding broke test isolation and silently reused production paths (2026-08-10)
...
### 6. GQ hand-labelling accepted invalid scores and silently no-op'd on typos (2026-07-29)
...
### 7. P3 build logged zero token cost despite generating real summaries (2026-08-04)
...
### 8. LLM temperature silently fell back to 0.1, not the mandated 0 (2026-08-04)
...
### 9. Empty filing-list argument was indistinguishable from "not provided" (2026-08-04)
...
### 10. No duplicate-question check let near-identical questions into the benchmark set (2026-08-04)
